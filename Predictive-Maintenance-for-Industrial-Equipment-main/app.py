...
if selected == "Home":
    ...
    <div style="font-size: 24px;">
        This application provides predictive maintenance insights for industrial machinery.<br><br>
        Use the navigation menu to explore different sections of the app:
        <ul>
            <li>Historical Data - View past machinery data</li>
            <li>Input Data - Enter or generate new sensor readings</li>
            <li>Results - See maintenance predictions</li>
            <li>Visualizations - Analyze data through graphs</li>
        </ul>
    </div>
